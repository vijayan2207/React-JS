...
export default class Welcome extends Component {
  ...
  handleSubmit(evt) {
    ...
    if(this.validate()){
      ...
      alert('Welcome Form is submitted');
    }
  }
        ...
        <div class="login">
          ...
          <div class="split right">  
            ...
            <div class="login-header">
              <h1>You are just few steps away</h1>
            </div>
            <div class="login-header">
              <h4>Please register to get a free Quote in few seconds</h4>
            </div>
              <p></p>
            ...
            <div class="text-field">
              ...
              <div class="text-center">
                <input type="submit" value="Register & Get a Free Quote"></input>
              </div>
              </Link>              
            </div>        
              <p></p>
