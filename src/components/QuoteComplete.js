  ...
  render() {
    ...
    <>
      <div class="login">
        ...
        <form>            
            <div><span class="txt1">
                <a href="/" className="Home-RegisterText">Home</a></span>
            </div>
            <br></br>
            <br></br>
            <br></br>
            ...
            <div class="quote-left-align"><h2>Your Contact details</h2></div><p></p>
                <div class="quote-text"><label>NAME: {this.state.firstname} {this.state.lastname}</label></div><p></p>
                <div class="quote-text"><label>EMAIL: {this.state.email}</label></div><p></p>
                <div class="quote-text"><label>PHONE: {this.state.phone}</label></div><p></p>

            <div class="quote-left-align"><h2>Your Quote details</h2></div><p></p>
                <div class="quote-text"><label>TERMS: {this.state.terms}</label></div><p></p>
                <div class="quote-text"><label>ORIGIN:{this.state.originCountry},{this.state.originCity}</label></div><p></p>
                <div class="quote-text"><label>DESTINATION:{this.state.destinationCountry},{this.state.destinationCity}</label></div><p></p>
                <div class="quote-text"><label>DUTY RATE:{this.state.dutyRates}%</label></div><p></p>

            <div class="quote-left-align"><h2>Your Package details</h2></div><p></p>
