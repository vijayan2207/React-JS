        ...
        <div class="split right">  
          <form onSubmit={this.handleSubmit}>
            ...
            <div class="text-center">
              <Link to={{ pathname: '/Quote', state: { email: this.state.email } }}><input type="button" value="      SIGN IN     "></input></Link>
            </div>
              <br></br>
              <br></br>
              <br></br>
            ...
            <div class="text-center">
              <p>
                <span class="txt1">New User?&nbsp;<a href="/Register" className="Register-link">Register</a>  </span>
              </p>
            </div>              
          </form>
      </div>
